...
const Card = ({ id, title, category, description, onAction, isCompleted, completedAction, imageIndex = 0, severity, lat, lng, date, municipality, ward, type, reportedAt }) => {
  ...
  return (
    <>
            ...
            <div className="bg-white rounded-2xl w-full max-w-md sm:max-w-2xl mx-4 overflow-hidden shadow-xl">
              <div className="relative bg-gray-100">
                {cardImage.type === "image" ? (
                  ...
                  <video src={cardImage.url} className="w-full h-52 sm:h-60 object-cover" controls autoPlay loop />
                )}
      ...
      />
      {showVideoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80" onClick={() => setShowVideoModal(false)}>
